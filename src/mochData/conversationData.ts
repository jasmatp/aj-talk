...
export const conversations: ConversationGroup[] = [
  {
    title: "Meeting | Conversations",
    ...
    conversations: [
      {
        ...
        linesGuj: [
          " S1: હેલો. તમે કેમ છો?",
          "S2: બહુ સારું, આભાર. અને તમે?",
          "S1: હું મજા માં છું, આભાર.",
          "S2: તમને ફરી મળીને આનંદ થયો.",
        ],
      },
      {
        id: "B",
        ...
        linesGuj: [
          "S1: તમે આજકાલ ક્યાં હતા?",
          "S2: હું વધારાના કામથી વ્યસ્ત હતો.",
          "S1: મને પણ ઘણું કામ કરવાનું હતું.",
          "S2: હા. મેં પણ તમને ઘણા સમયથી જોયા નથી.",
        ],
      },
      {
        id: "C",
        lines: [
          ...
          "S2: Fine, thanks. How's everything with you?",
          "S1: Just fine. What's new?",
          "S2: Nothing much.",
        ],
        linesGuj: [
          "S1: હેલો. બધું કેવી રીતે છે?",
          "S2: સારું છે, આભાર. તમારા બધું કેવી રીતે છે?",
          "S1: બધું બરાબર છે. શું નવું છે?",
          "S2: ખાસ કંઈ નથી.",
        ],
      },
      {
        ...
        linesGuj: [
          "S1: તમને મળીને આનંદ થયો.",
          "S2: આનંદ મને પણ છે.",
          "S1: મેં જ્હોનને તમારા વિશે ઘણી વાર વાત કરતાં સાંભળી છે.",
          "S2: આશા છે કે સારા જ શબ્દો હશે.",
        ],
      },
      {
        id: "E",
        ...
        linesGuj: [
          "S1: જુઓ, કોણ અહીં છે!",
          "S2: તમને મને જોઈને આશ્ચર્ય થયું?",
          "S1: હા. મને લાગ્યું કે તમે યુરોપમાં છો.",
          "S2: હુ્ ત્યાં હતો, પણ ગઈકાલે પરત આવી ગયો.",
        ],
      },
    ],
  },
  {
    title: "Parting | Conversations",
    ...
    conversations: [
      {
        ...
        linesGuj: [
          "S1: હવે મારી પાસે મળવાનું નિયુક્ત સમય છે.",
          "S2: હું પણ ખૂબ જ તાત્કાલિકમાં છું.",
          "S1: તમને જોઈને આનંદ થયો. અલવિદા.",
          "S2: અલવિદા. તમારું ધ્યાન રાખજો.",
        ],
      },
      {
        id: "B",
        ...
        linesGuj: [
          "S1: મને લાગે છે હવે જવું જોઈએ.",
          "S2: મને પણ હવે જવું છે.",
          "S1: તો પછી, ફરી મળશું.",
          "S2: અલવિદા. પછી મળશું.",
        ],
      },
      {
        ...
        linesGuj: [
          "S1: હવે મોડું થઈ રહ્યું છે, મને જવું જ છે.",
          "S2: તમને જવું પડે તેવા માટે અમે દુઃખી છીએ.",
          "S1: કૃપા કરી મને માફ કરો, નહિ કે?",
          "S2: જરૂર. વહેલું પાછા આવજો.",
        ],
      },
      {
        id: "D",
        ...
        linesGuj: [
          "S1: તમને મળીને મને આનંદ થયો.",
          "S2: આભાર. તમને જોઈને સારું લાગ્યું.",
          "S1: આશા છે કે અમે ફરી મળશું.",
          "S2: હા. હું તેનો આતુરતાથી ઇંતઝાર કરીશ.",
        ],
      },
      {
        id: "E",
        ...
        linesGuj: [
          "S1: મને લાગે છે કે હવે જવું પડશે.",
          "S2: તમને એટલો વહેલું જવું જ છે?",
          "S1: મને ખરેખર જવું જ પડશે.",
          "S2: હા, ફરી મળીને મજા આવી.",
        ],
      },
    ],
  },
    ...
    conversations: [
      {
        ...
        linesGuj: [
          "S1: તમે અંગ્રેજી બોલો છો?",
          "S2: ફક્ત થોડું અને એટલું સારું નથી.",
          "S1: તમે ઘણા શબ્દો જાણો છો?",
          "S2: ના, હું નથી જાણતો. ફક્ત મહત્વપૂર્ણ શબ્દો.",
        ],
      },
      {
        id: "B",
        ...
        linesGuj: [
          "S1: તમારા ભાઇ અંગ્રેજી બોલે છે?",
          "S2: હા, તે થોડું અંગ્રેજી બોલે છે.",
          "S1: તમારી બહેનો અંગ્રેજી બોલે છે?",
          "S2: હા, તે ખૂબ સારું બોલે છે.",
        ],
      },
      {
        id: "C",
        ...
        linesGuj: [
          ...
          "S2: હું ફક્ત ફ્રેંચ બોલું છું.",
          "S1: માફ કરશો, પરંતુ હું ફ્રેંચ નથી સમજો.",
          "S2: કૃપા કરીને કોઇ ફ્રેંચ બોલનાર શોધો.",
        ],
      },
      {
        id: "D",
        ...
        linesGuj: [
          "S1: સમસ્યા શું છે?",
          "S2: હું અંગ્રેજી નથી બોલતો.",
          "S1: શું તમને મદદ જોઈએ?",
          "S2: હા, પણ હું તેને અંગ્રેજીમાં સમજાવી શકતો નથી.",
        ],
      },
      {
        id: "E",
        ...
        linesGuj: [
          "S1: તમે શું માનો છો કે અંગ્રેજી સહેલી છે?",
          "S2: ના, હું એવું નથી માનતો.",
          "S1: તમે શું માટે એવું નથી માનતા?",
          "S2: કારણ કે હું તેને સમજી શકતો નથી.",
        ],
      },
    ],
  },
    ...
    conversations: [
      {
        ...
        linesGuj: [
          "S1: તમે ક્યારે ઊઠો છો?",
          "S2: હું લગભગ સાત પંદર પર ઊઠું છું.",
          "S1: તમારા ઘરમાં નાસ્તો કેટલા વાગ્યાનો હોય છે?",
          "S2: નાસ્તો હંમેશા આઠ કલાકના પંદર મિનિટ પહેલા હોય છે.",
        ],
      },
      {
        id: "B",
        ...
        linesGuj: [
          "S1: બપોરે તમે સામાન્ય રીતે શું કરો છો?",
          "S2: અમે સામાન્ય રીતે અભ્યાસ કરીએ છીએ અથવા વાંચીએ છીએ.",
          "S1: છૂટ્ટીના દિવસોમાં તમે સામાન્ય રીતે શું કરો છો?",
          "S2: અમે સામાન્ય રીતે રમત ગમતમાં આનંદ માણીએ છીએ અને મિત્રોનો મુલાકાત લઈએ છીએ.",
        ],
      },
      {
        id: "C",
        ...
        linesGuj: [
          "S1: શું તમે ક્યારેક મ્યુઝિયમ જાઓ છો?",
          "S2: હું ક્યારેક ક્યારેક જાઉં છું.",
          "S1: તમે કયા પ્રકારની વસ્તુઓ જોવી પસંદ કરો છો?",
          "S2: મને પ્રતિમાઓ અને જૂની ચિત્રકળાઓ જોવી ગમેછે.",
        ],
      },
      {
        id: "D",
        ...
        linesGuj: [
          "S1: શું તમે ટેલિવિઝન ઘણીવાર જુઓ છો?",
          "S2: હું ક્યારેક સાંજે જોવુ છું.",
          "S1: તમને ગઈકાલે રાત્રે ટેલિવિઝન જોયું હતું?",
          "S2: હા, મેં જોયું. મેં ઘણા સારા કાર્યક્રમો જોયા.",
        ],
      },
      {
        id: "E",
        ...
        linesGuj: [
          "S1: શું તમે ક્યારેક રેડિયો સાંભળો છો?",
          "S2: હા, હું દરરોજ રાત્રે લગભગ રેડિયો સાંભળું છું.",
          "S1: તમારો મનપસંદ કાર્યક્રમ કયો છે?",
          "S2: મને અગિયાર વાગ્યાનું થિયેટર સૌથી વધુ ગમે છે.",
        ],
      },
    ],
  },
